...
struct PlacementGroupCreationOptions {
  PlacementGroupCreationOptions(
      ...
      std::vector<std::unordered_map<std::string, std::string>> bundle_label_selector =
          {},
      std::vector<PlacementGroupSchedulingOption> placement_group_scheduling_options = {})
      : name_(std::move(name)),
        strategy_(strategy),
        ...
        placement_group_scheduling_options_(
            std::move(placement_group_scheduling_options)) {
  ...
  /// A list of scheduling options defining fallback strategies for scheduling.
  const std::vector<PlacementGroupSchedulingOption> placement_group_scheduling_options_;
};
